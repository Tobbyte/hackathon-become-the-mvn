...
Vor dem Start wählt der Spieler einen der drei folgenden Spielmodi:

Vorgegeben Kategorie:
Der Artikel stammt aus einem spezifisch ausgewählten Themenbereich.

Alles Zufällig:
Ein völlig zufälliger Wikipedia-Artikel wird ausgewählt.

Top 1000 nach Schwierigkeit:
Ein Artikel aus einer Liste der 1000 meistgesuchten Seitenaufrufe.
